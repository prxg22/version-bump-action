let applyPlugins,plugins,parse,check;_34f‍.x([["default",()=>recommendedBump]]);_34f‍.w("parse-commit-message",[["applyPlugins",["applyPlugins"],function(v){applyPlugins=v}],["plugins",["plugins"],function(v){plugins=v}],["parse",["parse"],function(v){parse=v}],["check",["check"],function(v){check=v}]]);
 ...
 * @public
 */
               function recommendedBump(commits, options) {
